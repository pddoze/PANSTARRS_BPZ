...
#IN VERSION THREE THE ERROR(RADIUS) OF THE POINT IS ESTIMATED TO BE A VERY GOOD
#SEEING OF 1 ARCSECOND ALSO IM ADDING THE SPECZ OF SDSS TO THE SORTED PS1 FILE
...
A = Table.read('PSZ2_G048.47+34.86_PS1_catalogSSV.txt', format='ascii', delimiter=' ') #the smaller catalogue

B = Table.read('PSZ2_G048.47+34.86_SDSS_catalogSSV.txt', format='ascii', delimiter=' ') 
...
write(A2, 'PANSTARRS_Sort_G048.txt')
